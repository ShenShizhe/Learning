...
//玩家下棋
Three_sons_chess_gamer(char board[ROW][COL], int row, int col)
{
	int x = 0, y = 0;
...
void Three_sons_chess_game()
{
	...
	{
		//printf("恭喜，您赢了！！\n");
		printf("格局Debull(这也能输的吗？？)\n");
	}
	else if (ret == '#')
	{
		//printf("抱歉，您输了！！\n");
		printf("格局Buff(恭喜，您赢了！！)\n");
	}
	else
	{
		//printf("对局结束，平局！！\n");
		printf("格局Buff(你就是神，你与我五五开！！)\n");
	}
}


void Three_sons_chess_game_test()
{
	int input = 0;
